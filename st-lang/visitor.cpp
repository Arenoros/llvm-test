...
null_visitor_c::~null_visitor_c(void) {
    return;
}

#define SYM_LIST(class_name_c, ...)                                                                                    \
    void* null_visitor_c::visit(class_name_c* symbol) {                                                                \
        return NULL;                                                                                                   \
    }
...
iterator_visitor_c::~iterator_visitor_c(void) {
    return;
}
...
fcall_iterator_visitor_c::~fcall_iterator_visitor_c(void) {
    return;
};

void fcall_iterator_visitor_c::prefix_fcall(symbol_c* symbol) {
    return;
};
void fcall_iterator_visitor_c::suffix_fcall(symbol_c* symbol) {
    return;
};
...
search_visitor_c::~search_visitor_c(void) {
    return;
}
...
#define SYM_REF1(class_name_c, ref1, ...)                                                                              \
    void* search_visitor_c::visit(class_name_c* symbol) {                                                              \
        if (symbol->ref1)                                                                                              \
            return symbol->ref1->accept(*this);                                                                        \
        return NULL;                                                                                                   \
    }
...
#define SYM_REF2(class_name_c, ref1, ref2, ...)                                                                        \
    void* search_visitor_c::visit(class_name_c* symbol) {                                                              \
        void* res = NULL;                                                                                              \
        if (symbol->ref1)                                                                                              \
            res = symbol->ref1->accept(*this);                                                                         \
        if (res != NULL)                                                                                               \
            return res;                                                                                                \
        if (symbol->ref2)                                                                                              \
            return symbol->ref2->accept(*this);                                                                        \
        return NULL;                                                                                                   \
    }
...
#define SYM_REF3(class_name_c, ref1, ref2, ref3, ...)                                                                  \
    void* search_visitor_c::visit(class_name_c* symbol) {                                                              \
        ...
        if (res != NULL)                                                                                               \
            return res;                                                                                                \
        if (symbol->ref2)                                                                                              \
            res = symbol->ref2->accept(*this);                                                                         \
        if (res != NULL)                                                                                               \
            return res;                                                                                                \
        if (symbol->ref3)                                                                                              \
            return symbol->ref3->accept(*this);                                                                        \
        return NULL;                                                                                                   \
    }
...
#define SYM_REF4(class_name_c, ref1, ref2, ref3, ref4, ...)                                                            \
    void* search_visitor_c::visit(class_name_c* symbol) {                                                              \
        ...
        if (res != NULL)                                                                                               \
            return res;                                                                                                \
        if (symbol->ref3)                                                                                              \
            res = symbol->ref3->accept(*this);                                                                         \
        if (res != NULL)                                                                                               \
            return res;                                                                                                \
        if (symbol->ref4)                                                                                              \
            return symbol->ref4->accept(*this);                                                                        \
        return NULL;                                                                                                   \
    }
...
#define SYM_REF5(class_name_c, ref1, ref2, ref3, ref4, ref5, ...)                                                      \
    void* search_visitor_c::visit(class_name_c* symbol) {                                                              \
        ...
        if (res != NULL)                                                                                               \
            return res;                                                                                                \
        if (symbol->ref4)                                                                                              \
            res = symbol->ref4->accept(*this);                                                                         \
        if (res != NULL)                                                                                               \
            return res;                                                                                                \
        if (symbol->ref5)                                                                                              \
            return symbol->ref5->accept(*this);                                                                        \
        return NULL;                                                                                                   \
    }
...
#define SYM_REF6(class_name_c, ref1, ref2, ref3, ref4, ref5, ref6, ...)                                                \
    void* search_visitor_c::visit(class_name_c* symbol) {                                                              \
        ...
        if (res != NULL)                                                                                               \
            return res;                                                                                                \
        if (symbol->ref5)                                                                                              \
            res = symbol->ref5->accept(*this);                                                                         \
        if (res != NULL)                                                                                               \
            return res;                                                                                                \
        if (symbol->ref6)                                                                                              \
            return symbol->ref6->accept(*this);                                                                        \
        return NULL;                                                                                                   \
    }
